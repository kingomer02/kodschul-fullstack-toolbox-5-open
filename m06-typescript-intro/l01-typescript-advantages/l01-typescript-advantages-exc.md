...
> **Worauf es ankommt:** `discount(100, "10")` liefert **90** - JavaScript wandelt den String still in eine Zahl um. `null` und `[]` ergeben beide **100**: ein plausibel aussehendes, aber falsches Ergebnis **ohne jede Fehlermeldung**. Das ist das Argument für TypeScript - nicht der sichtbare Absturz, sondern der unsichtbare Fehler.
