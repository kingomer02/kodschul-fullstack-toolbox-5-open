...
Datenhaltung (Repository) und fachliche Regeln (Service, z. B. Statuswechsel) bleiben unabhängig austauschbar - ein Wechsel von In-Memory zu MongoDB (Modul 15) betrifft dadurch nur das Repository, nicht den Service.
